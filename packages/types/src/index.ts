...
export interface ServerToClientEvents {
  ...
  'whiteboard:clear':()=>void; 'whiteboard:scroll':(d:{scrollTop:number})=>void; 'whiteboard:text':(d:{text:WhiteboardText})=>void; 'whiteboard:textUpdate':(d:{text:WhiteboardText})=>void; 'whiteboard:eraseRect':(d:{rect:EraseRectPayload})=>void;
